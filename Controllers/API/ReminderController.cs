...
namespace CarCareTracker.Controllers
{
    public partial class APIController
    {
        ...
        public IActionResult AllReminders(ReminderMethodParameter parameters)
        {
            ...
            var results = reminderResults.Select(x => new ReminderAPIExportModel { VehicleId = x.VehicleId.ToString(), Id = x.Id.ToString(), Description = x.Description, Urgency = x.Urgency.ToString(), Metric = x.Metric.ToString(), UserMetric = x.UserMetric.ToString(), Notes = x.Notes, DueDate = x.Date.ToShortDateString(), DueOdometer = x.Mileage.ToString(), DueDays = x.DueDays.ToString(), DueDistance = x.DueMileage.ToString(),IntervalMileage = x.IntervalMileage.ToString(), IntervalMonths = x.IntervalMonths.ToString(), Tags = string.Join(' ', x.Tags) });
